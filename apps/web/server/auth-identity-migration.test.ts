...
describe("auth identity ownership migration", () => {
  ...
  it("proposes exact trigger, index, Storage, suspension, and limiter hardening", () => {
    ...
    expect(proposal).toContain('CREATE POLICY "Profile photo owners can upload profile photos"');
    expect(proposal).toContain('CREATE POLICY "Profile photo owners can update profile photos"');
    expect(proposal).toContain('CREATE POLICY "Profile photo owners can delete profile photos"');
    ...
    expect(stagingHarness).toContain('bucket: "profile-photos"');
    ...
    expect(stagingHarness).toContain("profile_image_writes_denied_after_suspension");
