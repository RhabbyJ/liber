...
`User.avatarVariant` is an allowlisted Boring Avatars token for buyer profile display; it should stay nullable so existing accounts fall back to deterministic generated avatars.
