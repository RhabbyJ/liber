...
- `engineering/UPLOAD_MALWARE_SCANNING.md` — selected OPSWAT private-processing scanner and credential-blocked launch gate.
- `engineering/DEPENDENCY_AUDIT_2026-07-11.md` — current npm findings, reachability triage, and upgrade decision.
